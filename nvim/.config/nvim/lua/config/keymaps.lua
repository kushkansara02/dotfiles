...
map("n", "wh", "<C-w>h", { desc = "Go to left window" })
map("n", "wj", "<C-w>j", { desc = "Go to lower window" })
map("n", "wk", "<C-w>k", { desc = "Go to upper window" })
map("n", "wl", "<C-w>l", { desc = "Go to right window" })
